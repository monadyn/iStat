...
def init(tier):	
	...
	output_file = timeSpan + "_" + tier + "_multiplicity_wl" + workload + "-50ms.csv"
	output_file2 = timeSpan + "_" + tier + "_responsetime_wl" + workload + "-50ms.csv"
	output_file3 = timeSpan + "_" + tier + "_inout_wl" + workload + "-50ms.csv"

	output_file = tier + "_multiplicity_" + timeSpan +"_wl"+ workload + "-50ms.csv"
	output_file2 = tier + "_responsetime_" + timeSpan +"_wl"+ workload + "-50ms.csv"
	output_file3 = tier + "_inout_" + timeSpan +"_wl"+ workload + "-50ms.csv"
